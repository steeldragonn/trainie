    ...
    <>
      ...
      <div className="wholeContent">
        ...
        <div className="content6">
          <p>
            here we go lets go one two three put yur hands up yey yey yey, cmon
            people, feel the moment, feel the rhytm, move right, move left, move
            around, feel the music, be alive.
          </p>
        </div>
      </div>
    </>
